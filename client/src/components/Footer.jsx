...
const Footer = () => {
  return (
    <footer className="border-t border-slate-800/50" style={{ backgroundColor: '#0a0f1e' }}>
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          {/* Brand */}
          <div className="md:col-span-2">
            <Link to="/" className="inline-flex items-center gap-2.5 mb-5">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-primary/25">
                D
              </div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-md mb-6">
              Premium car rental platform connecting you with verified owners. 
              Browse, compare, and book the perfect car for your next journey — all in one place.
            </p>
            <div className="flex gap-3">
              {/* Twitter */}
              <a href="#" className="w-10 h-10 rounded-lg bg-slate-800/60 flex items-center justify-center text-slate-400 hover:text-primary hover:bg-primary/10 transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: 'Become an Owner', path: '/owner' },
              ].map((link) => (
                <li key={link.path}>
                  <Link to={link.path} className="text-sm text-slate-400 hover:text-primary transition-colors">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm text-slate-400 flex items-start gap-2.5">
